    ...
    <div class="container pb-5">
        <div class="row">
            ...
            <div class="col-12 col-lg-9  py-5  mx-auto">
                <h1 class="titulo1 pb-5 text-uppercase text-center">Fotomatón para eventos</h1>
                <p class="p-home px-5">
            ...
            <div class="col-12 col-md-6 d-flex justify-content-center">
                <img src="assets/img/eventos-1.jpeg"class="img-fluid" style="object-fit:contain" alt="">
            </div>
            ...
            <h3 class="text-center incluye fs-1  h1 mt-5">¿Qué incluye?</h6>
