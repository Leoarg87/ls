    ...
    <div class="container-fluid px-0 " style="min-height:400px">
        ...
        <div class="row w-100 m-auto">
            ...
            <div class="col-12 col-lg-6 d-flex flex-column my-auto py-3 py-lg-5 mx-auto">
                <h2 class="h2-banner-solicita">Solicita nuestro pack <br> para bodas</h2>
                <hr class="hr-pack">
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-12 col-lg-6">
                <p class="p-home mt-3">
                    Nuestro Pack de Boda consiste en <b> un fotomatón y photocall </b> con tres horas de duración, hay posibilidad de horas extras si lo necesitáis, nos adaptamos al temática de tu boda para garantizar que todo estará perfecto en el que será uno de los días más importantes de vuestras vida.
                </p>
                <p class="p-home mt-3">
